...
import { FixtureResponse } from 'src/interfaces/FixtureResponse';
...
export class TeamHistoryComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private standingService: StandingService, private location: Location) { }
  teamId!: number;
